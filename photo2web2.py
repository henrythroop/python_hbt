...
for i,file in enumerate(files_original):
    ...
    caption_i = captions[i].replace('"', '&quot;')
    caption_i = caption_i.replace("'", '&#x27;')
    ...
    line_span = f'<span class="item" data-sub-html="<span class=caption>{caption_i}</span>"' + \
...
# To change the caption font size, alignment, etc.: edit .lg-sub-html and its descendents in the lightgallery.css .