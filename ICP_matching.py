...
https://gist.github.com/ecward/c373932638fd04a2243e (py2 -- I converted to py3)

With references from:

http://stackoverflow.com/questions/20120384/iterative-
              closest-point-icp-implementation-on-python

The idea here is to match 2D clouds of points -- that is, find the translation
between a set of stars in a catalog, and a set of (partially matching) stars from 
...
def icp(a, b, init_pose=(0,0,0), no_iterations = 3):    
    '''
